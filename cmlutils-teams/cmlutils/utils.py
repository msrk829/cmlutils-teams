...
def compare_metadata(
    import_data, export_data, import_data_list, export_data_list, skip_field=None, user_id_key='name'
):
    ...
    import_data_dict = {data[user_id_key]: data for data in import_data}
    export_data_dict = {data[user_id_key]: data for data in export_data}
