...
class ApiV1Endpoints(Enum):
    ...
    USER_TEAM_LIST = "/api/v1/site/users?limit=$limit&offset=$offset&order_by=last_seen_at&order_sort=desc"
    ADD_TEAM = "/api/v1/users"
    DEL_TEAM = "/api/v1/users/$team"

    TEAM_MEMBER_ADD = "/api/v1/users/$team/members"
    PROJECT_COLLABORATOR_LIST = "/api/v1/projects/$username/$project_name/collaborators"
    CREATE_COLLABORATORS = "/api/v1/projects/$api_username/$project_name/collaborators/$username"
